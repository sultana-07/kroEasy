...
export default function CarCard({ car, userId }) {
  ...
  const goToProfile = () => navigate(`/profile/car/${car._id}`);
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px' }}>
        <div>
          <div style={{ fontSize: '17px', fontWeight: '700', color: '#0F172A' }}>🚗 {car.carName} <span style={{ fontSize: '10px', verticalAlign: 'middle', opacity: 0.5 }}>›</span></div>
